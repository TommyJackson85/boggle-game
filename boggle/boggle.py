...
def make_grid(width, height): #0 0, from first test
    """
    Creates a grid that will hold all of the tiles 
    for a boggle game (if grid is empty, i.e. {}, it will fail)
    choice(ascii_uppercase). choice returns item from a list.
    """
...
if __name__ == "__main__":
    #only conditionally runs main()
    main()#should give result, 